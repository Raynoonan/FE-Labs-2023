...
let myTodoList = [];
// Step 2:
myTodoList.push("Dishes", "Laundry", "Homework")
console.log(myTodoList)
// Step 3: 
myTodoList.splice(1, 1)
console.log(myTodoList)
// Step 4:
let yourTodoList = ["Do lab", "Fix car"]
console.log(yourTodoList)
// Step 5: 
let ourTodoList = ["Brush dog", "Water plants"]
let lists = myTodoList.concat(yourTodoList, ourTodoList)
console.log(lists)
