...
//Answer: Besides the innerHTML, you can change the style of your page and the layout.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
    myForm.style.backgroundColor = 'rgb(157, 218, 148)'
    myForm.style.color = 'rgb(16, 100, 71)'
...
//Answer: Styling with JavaScript makes a little more sense to me. 
...
cell1.textContent = "Ray"
cell2.textContent = "Ray@yahoo.com"

let secondRow = myTable.insertRow(2)

const cell3 = secondRow.insertCell(0)
const cell4 = secondRow.insertCell(1)
cell3.textContent = "Josh"
cell4.textContent = "Josh@gmail.com"
...
//Answer: Using JavaScript for making a table could be more beneficial for making live changes
...
//Answer: mouseover, mouseout, resize, 
